...
namespace RollerTest.WebUI.Controllers
{
    public class RollerBaseStationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RollerBaseStationID,Device,Station,Sensor")] RollerBaseStation rollerBaseStation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RollerBaseStationID,Device,Station,Sensor")] RollerBaseStation rollerBaseStation)
        {
            if (ModelState.IsValid)
            {
